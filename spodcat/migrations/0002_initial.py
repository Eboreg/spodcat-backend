    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="podcasts", to=settings.AUTH_USER_MODEL, verbose_name="authors"
            ),
        ),
        migrations.AddField(
            model_name="podcast",
        ...
        migrations.AddField(
            ...
            name="podcast",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="+", to="spodcat.podcast"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("slug", "podcast"), name="podcasts__podcastcontent__slug_podcast__uq"
            ),
        ),
        migrations.AddIndex(
            model_name="podcast",
