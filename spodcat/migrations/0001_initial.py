    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "term1",
                    models.PositiveSmallIntegerField(default=spodcat.models.challenge.generate_term),
                ),
                (
                    "term2",
                    models.PositiveSmallIntegerField(default=spodcat.models.challenge.generate_term),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    martor.models.MartorField(blank=True, default=None, null=True, verbose_name="description"),
                ),
                ("id", models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ...
                (
                    ...
                    models.DateTimeField(
                        default=spodcat.utils.round_to_whole_hour,
                        help_text="Will be rounded down to the nearest whole hour.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "end_time",
                    spodcat.model_fields.TimestampField(blank=True, default=None, null=True, verbose_name="end time"),
                ),
                (
                    "image",
                    models.ImageField(
                        ...
                        max_length=300,
                        null=True,
                        storage=spodcat.models.functions.episode_chapter_image_storage,
                        upload_to=spodcat.models.functions.episode_chapter_image_upload_to,
                        verbose_name="image",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        storage=spodcat.models.functions.fontface_file_storage,
                        upload_to=spodcat.models.functions.fontface_file_upload_to,
            ...
            fields=[
                (
                    ...
                    models.ImageField(
                        ...
                        max_length=300,
                        null=True,
                        storage=spodcat.models.functions.podcast_banner_storage,
                        upload_to=spodcat.models.functions.podcast_banner_upload_to,
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        default=None,
                        help_text=(
                            "This is the round 'avatar' image. It should ideally have height and width >= 1400px."
                        ),
                        max_length=300,
                        null=True,
                        storage=spodcat.models.functions.podcast_cover_storage,
                        upload_to=spodcat.models.functions.podcast_cover_upload_to,
                        verbose_name="cover",
                    ),
                ),
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        max_length=300,
                        null=True,
                        storage=spodcat.models.functions.podcast_cover_thumbnail_storage,
                        upload_to=spodcat.models.functions.podcast_cover_thumbnail_upload_to,
                    ),
                ),
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        max_length=300,
                        null=True,
                        storage=spodcat.models.functions.podcast_favicon_storage,
                        upload_to=spodcat.models.functions.podcast_favicon_upload_to,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=spodcat.models.podcast.get_language_choices,
                        default=None,
                        max_length=5,
                        null=True,
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="normal",
                        max_length=10,
                        verbose_name="name font size",
                    ),
                ),
                (
                    "require_comment_approval",
                    models.BooleanField(default=True, verbose_name="require comment approval"),
                ),
                (
                    "slug",
                    models.SlugField(
                        help_text="Will be used in URLs.",
                        primary_key=True,
                        serialize=False,
                        validators=[spodcat.models.podcast.podcast_slug_validator],
                        verbose_name="slug",
                    ),
                ),
                (
                    "tagline",
                    models.CharField(blank=True, default=None, max_length=500, null=True, verbose_name="tagline"),
                ),
                (
                    "custom_guid",
                    models.UUIDField(
                        blank=True,
                        default=None,
                        help_text="Don't set if you don't know what you're doing. Ref: https://podcasting2.org/podcast-namespace/tags/guid",
                        null=True,
                ...
                (
                    "itunes_type",
                    models.CharField(
                        choices=[("episodic", "Episodic"), ("serial", "Serial")], default="episodic", max_length=10
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        max_length=300,
                        null=True,
                        storage=spodcat.models.functions.podcast_link_icon_storage,
                        upload_to=spodcat.models.functions.podcast_link_icon_upload_to,
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        max_length=300,
                        null=True,
                        storage=spodcat.models.functions.season_image_storage,
                        upload_to=spodcat.models.functions.season_image_upload_to,
                        verbose_name="image",
                    ),
                ),
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        max_length=300,
                        null=True,
                        storage=spodcat.models.functions.season_image_thumbnail_storage,
                        upload_to=spodcat.models.functions.season_image_thumbnail_upload_to,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        ...
                        max_length=300,
                        null=True,
                        storage=spodcat.models.functions.episode_audio_file_storage,
                        upload_to=spodcat.models.functions.episode_audio_file_upload_to,
                        verbose_name="audio file",
                    ),
                ),
                (
                    "audio_file_length",
                    models.PositiveIntegerField(blank=True, db_index=True, default=0, verbose_name="audio file length"),
                ),
                ("dbfs_array", models.JSONField(blank=True, default=list, verbose_name="dBFS array")),
                (
                    "duration_seconds",
                    models.FloatField(blank=True, db_index=True, default=0.0, verbose_name="duration"),
                ),
                (
                    "image",
                    models.ImageField(
                        ...
                        max_length=300,
                        null=True,
                        storage=spodcat.models.functions.episode_image_storage,
                        upload_to=spodcat.models.functions.episode_image_upload_to,
                        verbose_name="image",
                    ),
                ),
                ("image_height", models.PositiveIntegerField(default=None, null=True)),
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        max_length=300,
                        null=True,
                        storage=spodcat.models.functions.episode_image_thumbnail_storage,
                        upload_to=spodcat.models.functions.episode_image_thumbnail_upload_to,
                    ),
                ),
                ("image_thumbnail_height", models.PositiveIntegerField(default=None, null=True)),
                ("image_thumbnail_mimetype", models.CharField(default=None, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "comment",
                    models.CharField(blank=True, default=None, max_length=100, null=True, verbose_name="comment"),
                ),
                ("title", models.CharField(max_length=100, verbose_name="title")),
                (
                    "artists",
                    models.ManyToManyField(
                        blank=True, related_name="songs", to="spodcat.artist", verbose_name="artists"
                    ),
                ),
            ],
            options={
