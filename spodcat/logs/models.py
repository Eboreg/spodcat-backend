...
class RequestLog(ModelMixin, models.Model):
    ...
    def fill_remote_hosts(cls):
        ips = list(
            cls.objects.filter(Q(remote_host="") | Q(remote_addr__startswith=F("remote_host")))
            .exclude(remote_addr=None)
            .order_by()
            .values_list("remote_addr", flat=True)
            .distinct()
...
class PodcastRequestLog(RequestLog):
    ...
    objects: ClassVar["PodcastRequestLogManager"] = PodcastRequestLogQuerySet.as_manager()
...
class PodcastContentRequestLog(RequestLog):
    ...
    objects: ClassVar["PodcastContentRequestLogManager"] = PodcastContentRequestLogQuerySet.as_manager()
...
class PodcastEpisodeAudioRequestLog(RequestLog):
    ...
    objects: ClassVar["PodcastEpisodeAudioRequestLogManager"] = PodcastEpisodeAudioRequestLogQuerySet.as_manager()
...
class PodcastRssRequestLog(RequestLog):
    ...
    objects: ClassVar["PodcastRssRequestLogManager"] = PodcastRssRequestLogQuerySet.as_manager()
