    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("app", "App"), ("bot", "Bot"), ("browser", "Browser"), ("library", "Library")],
                        db_index=True,
                        max_length=10,
                        verbose_name="type",
                    ),
                ...
                (
                    "user_agent",
                    models.CharField(max_length=400, primary_key=True, serialize=False, verbose_name="user agent"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "path_info",
                    klaatu_django.db.TruncatedCharField(blank=True, default="", max_length=200, verbose_name="path"),
                ),
                (
                    "referrer",
                    klaatu_django.db.TruncatedCharField(
                        blank=True, default="", max_length=150, verbose_name="referrer"
                    ),
                ),
                (
                    "referrer_category",
                    models.CharField(
                        choices=[("app", "App"), ("host", "Host")],
                        default=None,
                        max_length=10,
                        null=True,
                        verbose_name="referrer category",
                    ),
                ),
                (
                    "referrer_name",
                    models.CharField(blank=True, default="", max_length=50, verbose_name="referrer name"),
                ),
                (
                    "remote_addr",
                    models.GenericIPAddressField(db_index=True, default=None, null=True, verbose_name="remote address"),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        default="unknown",
                        max_length=20,
                        verbose_name="remote address category",
                    ),
                ),
