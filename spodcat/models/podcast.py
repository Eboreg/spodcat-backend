...
class Podcast(ModelMixin, models.Model):
    ...
    custom_guid = models.UUIDField(
        ...
        help_text=_(
            "Don't set if you don't know what you're doing. Ref: https://podcasting2.org/podcast-namespace/tags/guid"
        ),
    )
    ...
    objects: ClassVar["PodcastManager"] = PodcastQuerySet.as_manager()
