...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('logs', '0007_alter_podcastcontentaudiorequestlog2_episode_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geoip', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='logs.geoip')),
                ('user_agent_data', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='logs.useragent')),
            ],
            options={
                'ordering': ['-created'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('episode', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audio_requests', to='podcasts.episode')),
                ('rss_request_log', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='logs.podcastrssrequestlog')),
            ],
            bases=('logs.requestlog',),
        ),
    ]
