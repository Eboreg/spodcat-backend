    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referrer', klaatu_django.db.TruncatedCharField(blank=True, default='', max_length=150)),
        ...
        migrations.CreateModel(
            name='UserAgent',
            fields=[
                ('user_agent', models.CharField(max_length=400, primary_key=True, serialize=False)),
