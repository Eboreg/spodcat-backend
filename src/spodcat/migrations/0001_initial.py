...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Podcast',
            fields=[
                ('banner', models.ImageField(blank=True, default=None, help_text='Should be >= 960px wide and have aspect ratio 3:1.', max_length=300, null=True, upload_to=spodcat.models.functions.podcast_banner_upload_to, verbose_name='banner image')),
                ...
                ('cover', models.ImageField(blank=True, default=None, help_text="This is the round 'avatar' image. It should ideally have height and width >= 1400px.", max_length=300, null=True, upload_to=spodcat.models.functions.podcast_cover_upload_to, verbose_name='cover')),
                ...
                ('cover_thumbnail', models.ImageField(blank=True, default=None, max_length=300, null=True, upload_to=spodcat.models.functions.podcast_cover_thumbnail_upload_to)),
                ...
                ('favicon', models.ImageField(blank=True, default=None, max_length=300, null=True, upload_to=spodcat.models.functions.podcast_favicon_upload_to, verbose_name='favicon')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio_file', models.FileField(blank=True, default=None, max_length=300, null=True, upload_to=spodcat.models.functions.episode_audio_file_upload_to, verbose_name='audio file')),
                ...
                ('image', models.ImageField(blank=True, default=None, max_length=300, null=True, upload_to=spodcat.models.functions.episode_image_upload_to, verbose_name='image')),
                ...
                ('image_thumbnail', models.ImageField(blank=True, default=None, max_length=300, null=True, upload_to=spodcat.models.functions.episode_image_thumbnail_upload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('podcast', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='spodcat.podcast')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('custom_icon', models.ImageField(blank=True, default=None, max_length=300, null=True, upload_to=spodcat.models.functions.podcast_link_icon_upload_to, verbose_name='custom icon')),
                ...
                ('podcast', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='links', to='spodcat.podcast', verbose_name='podcast')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default=None, max_length=300, null=True, upload_to=spodcat.models.functions.episode_chapter_image_upload_to, verbose_name='image')),
