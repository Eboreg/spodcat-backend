    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geoip', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='logs', to='spodcat_logs.geoip')),
                ('user_agent_data', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='logs', to='spodcat_logs.useragent', verbose_name='user agent data')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('requestlog_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='spodcat_logs.requestlog')),
                ('created', models.DateTimeField(db_index=True, verbose_name='created')),
                ('content', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requests', to='spodcat.podcastcontent')),
            ],
            options={
                'verbose_name': 'podcast content page request log',
                'verbose_name_plural': 'podcast content page request logs',
            },
            bases=('spodcat_logs.requestlog',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('episode', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audio_requests', to='spodcat.episode')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('requestlog_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='spodcat_logs.requestlog')),
                ('created', models.DateTimeField(db_index=True, verbose_name='created')),
                ('podcast', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requests', to='spodcat.podcast')),
            ],
            options={
