    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geoip', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='logs', to='spodcat_logs.geoip', verbose_name='GeoIP')),
