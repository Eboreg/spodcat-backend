...
from spodcat.ip_check import (
    IpAddressCategory,
    get_geoip2_asn,
    get_geoip2_city,
    get_ip_address_category,
)
from spodcat.models.querysets import PodcastEpisodeAudioRequestLogQuerySet
from spodcat.user_agent import (
    DeviceCategory,
    UserAgentData,
    UserAgentType,
    get_referrer_dict,
...
if TYPE_CHECKING:
    ...
    from spodcat.models.querysets import PodcastEpisodeAudioRequestLogManager
...
class RequestLog(ModelMixin, models.Model):
    ...
    remote_addr = models.GenericIPAddressField(null=True, db_index=True, default=None, verbose_name=_("remote address"))
...
class PodcastRssRequestLog(ModelMixin, models.Model):
    created = models.DateTimeField(db_index=True, auto_now_add=True, verbose_name=_("created"))
    path_info = TruncatedCharField(max_length=50, blank=True, default="", verbose_name=_("path"))
    ...
    referrer = TruncatedCharField(max_length=100, blank=True, default="", verbose_name=_("referrer"))
