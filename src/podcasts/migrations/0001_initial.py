    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', martor.models.MartorField(blank=True, default=None, null=True)),
                ('cover', models.ImageField(blank=True, default=None, height_field='cover_height', help_text="This is the round 'avatar' image.", null=True, upload_to=podcasts.models.podcast.podcast_image_path, validators=[podcasts.validators.podcast_cover_validator], width_field='cover_width')),
                ...
                ('banner', models.ImageField(blank=True, default=None, height_field='banner_height', help_text='Should be >= 960px wide and have aspect ratio 3:1.', null=True, upload_to=podcasts.models.podcast.podcast_image_path, verbose_name='Banner image', width_field='banner_width')),
