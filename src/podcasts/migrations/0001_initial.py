...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Podcast',
            fields=[
                ('slug', models.SlugField(primary_key=True, serialize=False, validators=[podcasts.validators.podcast_slug_validator])),
                ('name', models.CharField(max_length=100)),
                ('tagline', models.CharField(blank=True, default=None, max_length=500, null=True)),
                ('description', martor.models.MartorField(blank=True, default=None, null=True)),
                ('cover', models.ImageField(blank=True, default=None, height_field='cover_height', null=True, upload_to=podcasts.models.podcast.podcast_image_path, validators=[podcasts.validators.podcast_cover_validator], width_field='cover_width')),
                ...
                ('cover_thumbnail', models.ImageField(blank=True, default=None, height_field='cover_thumbnail_height', null=True, upload_to=podcasts.models.podcast.podcast_image_path, width_field='cover_thumbnail_width')),
                ...
                ('banner', models.ImageField(blank=True, default=None, height_field='banner_height', null=True, upload_to=podcasts.models.podcast.podcast_image_path, width_field='banner_width')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio_file', models.FileField(upload_to=podcasts.models.episode.episode_audio_file_path)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['timestamp'], name='podcasts_ep_timesta_51d438_idx'),
        ),
    ]
