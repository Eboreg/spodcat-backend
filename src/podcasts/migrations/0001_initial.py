    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published', models.DateField(default=podcasts.models.podcast_content.today)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theme', models.CharField(choices=[('primary', 'Primary'), ('secondary', 'Secondary'), ('tertiary', 'Tertiary'), ('boring', 'Boring')], default='primary', max_length=10)),
                ('url', models.URLField()),
            ],
            options={
                'ordering': ['order'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.FloatField(blank=True, default=None, null=True)),
